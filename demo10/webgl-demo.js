...
function main() {
  ...
  const programInfo = {
    ...
    uniformLocations: {
      ...
      lightDirection: gl.getUniformLocation(shaderProgram,'u_light')
    },
  };
...
function drawScene(gl, programInfo, buffers, deltaTime) {
  ...
  mat4.rotate(modelViewMatrix,  // destination matrix
              modelViewMatrix,  // matrix to rotate
              cubeRotation * 2.2,// amount to rotate in radians
  ...
  gl.uniformMatrix4fv(
      ...
      false,
      modelViewMatrix);
  let lightVec = vec3.create()
  vec3.normalize(lightVec,[0.1,0.3,0.8])
  gl.uniform3fv(
